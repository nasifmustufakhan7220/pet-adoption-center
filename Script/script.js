  ...
  cards.forEach((card) => {
    ...
    cardDiv.innerHTML = `
        ...
        <div class="flex items-center gap-2 border-t border-gray-100 pt-2 w-full">
            ...
            <button class="btn btn-outline sm:btn-sm text-teal-500 border-teal-500 hover:bg-teal-500 hover:text-white flex-1">Adopt</button>
            <button class="btn btn-outline sm:btn-sm text-teal-500 border-teal-500 hover:bg-teal-500 hover:text-white flex-1">Details</button>
            </div>
        </div>
        `;
